const sites = [
    { title: "Vercel", description: "Hızlı ve verimli frontend platformu.", url: "https://vercel.com" },
      ...
      { title: "werarew sheet", description: "tablo uyqulamas;", url: "https://theprocramer.github.io/werarew-sheet/" },
       { title: "exemplesoft engine", description: "create game oyun geliştirme", url: "https://theprocramer.github.io/exemplesoft-engine" },
...
{ title: "werarew sheet", description: "table application", url: "https://theprocramer.github.io/werarew-sheet/" },
  { title: "Vercel", description: "Hızlı və səmərəli cəbhə platforması.", url: "https://vercel.com" }, 
  { title: "Dribbble", description: "Tasarımcılar üçün bir portföy və keşif platforması.", url: "https://dribbble.com" }, 
  { title: "Awwwards", description: "En yaxşı web tasarımlarını mükafatlandıran platforma.", url: "https://awwwards.com" }, 
  { title: "CSS-Tricks", description: "Web inkişaf və dizayn ipuçları.", url: "https://css-tricks.com" }, 
  { title: "Adobe Portfolio", description: "Adobe'nin sunduğu portföy yaratmaq vasitəsi.", url: "https://portfolio.adobe.com" }, 
  { title: "Behance", description: "Sanatçılar ve tasarımcılar üçün portföy platformu.", url: "https://behance.net" }, 
  { title: "CodePen", description: "Kod paylaşımı və veb dizayn proqramları.", url: "https://codepen.io" }, 
  { title: "GitHub", description: "Açık kaynak projelerinin paylaşıldığı platforma.", url: "https://github.com" }, 
  { title: "Stack Overflow", description: "Geliştiriciler üçün soru-cevap platforması.", url: "https://stackoverflow.com" }, 
  { title: "MDN Web Docs", description: "Mozilla'nın veb inkişaf dökümantasyonları.", url: "https://developer.mozilla.org" }, 
  { title: "Smashing Magazine", description: "Veb dizaynı və inkişafı ilə əlaqədar kaynaklar.", url: "https://smashingmagazine.com" }, 
  { title: "UX Design", description: "Kullanıcı təcrübə dizaynı kaynakları və məqalələr.", url: "https://uxdesign.cc" }, 
  { title: "Figma", description: "Web tabanlı tasarım və prototipleme aracı.", url: "https://figma.com" }, 
  { title: "Canva", description: "Kullanıcı dostu qrafik dizayn aracı.", url: "https://canva.com" }, 
  { title: "Webflow", description: "Kod yazmadan web dizaynı yapmanı təmin edən platforma.", url: "https://webflow.com" }, 
  { title: "Trello", description: "Proje rəhbərliyi və vəzifə takibi platforması.", url: "https://trello.com" }, 
  { title: "Anlayış", description: "Dijital not alma ve təşkilat platforması.", url: "https://notion.so" }, 
  { title: "Google Fonts", description: "Web üçün pulsuz yazı tipləri.", url: "https://fonts.google.com" }, 
  { title: "Medium", description: "İçərik paylaşımı və blog platforması.", url: "https://medium.com" }, 
  { title: "Envato Market", description: "Veb dizayn və proqram kaynakları platforması.", url: "https://envato.com" }, 
  { title: "W3Schools", description: "Web inkişaf etdirmək öyrənmək üçün kaynak.", url: "https://w3schools.com" }, 
  { title: "Moz", description: "SEO və dijital pazarlama vasitələri.", url: "https://moz.com" }, 
  { title: "Mailchimp", description: "E-posta pazarlama platforması.", url: "https://mailchimp.com" }, 
  { title: "Zapier", description: "İş axınını avtomatikləşdirən araç.", url: "https://zapier.com" }, 
  { title: "Shopify", description: "E-ticaret mağazası yaratma platforması.", url: "https://shopify.com" }, 
  { title: "DigitalOcean", description: "Bulut sunucuları təmin edən platforma.", url: "https://digitalocean.com" }, 
  { title: "Heroku", description: "Bulut platforması və tətbiq barındırma xidməti.", url: "https://heroku.com" }, 
  { title: "WordPress", description: "Dünya geniş populyar məzmun idarəetmə sistemi.", url: "https://wordpress.com" }, 
  { title: "Quora", description: "Soru-cevap platforması, istifadəçilər sorğular sorar və cavablar alır.", url: "https://quora.com" }, 
  { title: "LinkedIn", description: "Profesyonel ağ kurma və iş arama platforması.", url: "https://linkedin.com" }, 
  { title: "Instagram", description: "Görsel və video paylaşımı platforması.", url: "https://instagram.com" }, 
  { title: "Pinterest", description: "Fikir paylaşımı və görsel keşif platforması.", url: "https://pinterest.com" }, 
  { title: "Reddit", description: "Haber ve topluluq platforması.", url: "https://reddit.com" }, 
  { title: "Twitter", description: "Kısa mesajlaşma və xəbərləşmə platforması.", url: "https://twitter.com" }, 
  { title: "Facebook", description: "Sosyal medya ve haberleşme platforması.", url: "https://facebook.com" }, 
  { title: "YouTube", description: "Video paylaşım və yayım platforması.", url: "https://youtube.com" }, 
  { title: "Netflix", description: "Dijital film ve dizi akış platforması.", url: "https://netflix.com" }, 
  { title: "Spotify", description: "Müzik dinləmə platforması.", url: "https://spotify.com" }, 
  { title: "Apple", description: "Teknolojik məhsullar və yazılımlar istehsal edən firma.", url: "https://apple.com" }, 
  { title: "Amazon", description: "E-ticaret ve teknoloji şirkəti.", url: "https://amazon.com" }, 
  { title: "werarew hesabatı", description: "tablo uykulamas;", url: "https://theprocramer.github.io/werarew-sheet/" }, 
  { title: "examplesoft mühərriki", description: "oyun yaratmaq oyun yaratmaq", url: "https://theprocramer.github.io/examplesoft-engine" }
